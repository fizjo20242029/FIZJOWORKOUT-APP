...
BAZA_FIZJO = {
    ...
    "Neurologia i Koordynacja": [
        ...
        {"nazwa": "Neuromobilizacja nerwu kulszowego (Slump Test)", "opis": "INSTRUKCJA: Siad z zaokrąglonymi plecami (slump), broda przyciągnięta do mostka. Prostuj kolano i zadzieraj stopę na siebie z JEDNOCZESNYM uniesieniem głowy w górę, następnie zginaj kolano opuszczając głowę (technika ślizgowa).", "czas_min": 3, "parametry": "15 płynnych ruchów", "miesnie": "Opony rdzeniowe, nerw kulszowy"},
        {"nazwa": "Neuromobilizacja nerwu pośrodkowego (ULNT 1)", "opis": "INSTRUKCJA: Leżenie tyłem lub siad. Odwiedź ramię do 90 st. Wykonuj naprzemienne zgięcie nadgarstka przy wyproście łokcia, a następnie wyprost nadgarstka przy zgięciu łokcia.", "czas_min": 2, "parametry": "15 płynnych ruchów", "miesnie": "Nerw pośrodkowy, splot ramienny"},
        {"nazwa": "PNF - Wzorzec łopatki (Depresja tylna)", "opis": "INSTRUKCJA: Leżenie na boku, terapeuta trzyma łopatkę. Wykonuj ruch łopatką w kierunku dolnym i tylnym (do kręgosłupa) pokonując opór. Stabilizuje to dolny tułów i obręcz barkową.", "czas_min": 2, "parametry": "3x10 powtórzeń", "miesnie": "Czworoboczny dolny, najszerszy grzbietu"},
        {"nazwa": "PNF - D1 Zgięcie kończyny dolnej", "opis": "INSTRUKCJA: Leżenie tyłem. Ruch prowadzony od wyprostu/odwodzenia do zgięcia, przywiedzenia i rotacji zewnętrznej biodra (ruch przypominający zakładanie nogi na nogę), stopa zadarta.", "czas_min": 3, "parametry": "10 powtórzeń na nogę", "miesnie": "Łańcuchy kinematyczne kończyny dolnej"},
        {"nazwa": "Równowaga na berecie sensomotorycznym", "opis": "INSTRUKCJA: Stanie jednonóż na poduszce sensomotorycznej, kolano lekko ugięte. Dla utrudnienia wykonuj powolne ruchy głową na boki lub zamknij oczy.", "czas_min": 3, "parametry": "3x45 sekund na nogę", "miesnie": "Propriocepcja, stawy skokowe"},
        {"nazwa": "Ćwiczenia Frenkla w siadzie (Precyzja)", "opis": "INSTRUKCJA: Siad na krześle. Patrząc na swoje stopy, dotykaj precyzyjnie piętą wyznaczonych na podłodze punktów (np. krzyżyków z taśmy izolacyjnej).", "czas_min": 2, "parametry": "2 minuty", "miesnie": "Koordynacja wzrokowo-ruchowa"},
        {"nazwa": "Reakcje równoważne w klęku podpartym (Perturbacje)", "opis": "INSTRUKCJA: Klęk podparty na miękkim materacu. Terapeuta (lub asystent z gumą) wytrąca Cię z równowagi lekkimi pchnięciami w różnych kierunkach. Musisz utrzymać stabilną pozycję.", "czas_min": 3, "parametry": "3 minuty", "miesnie": "Reakcje następcze, stabilizacja centralna"},
        {"nazwa": "Chód tandemowy (Stopa za stopą)", "opis": "INSTRUKCJA: Stanie prosto. Idź przed siebie po linii prostej, stawiając piętę jednej stopy tak, by dotykała palców drugiej stopy (jak linoskoczek).", "czas_min": 2, "parametry": "3x10 metrów", "miesnie": "Równowaga dynamiczna, błędnik"},
        {"nazwa": "Przekraczanie linii środkowej ciała", "opis": "INSTRUKCJA: Siad na piłce. Sięgaj prawą ręką do lewej stopy, a następnie płynnym ruchem przenoś rękę w prawo i wysoko w górę po skosie, śledząc dłoń wzrokiem.", "czas_min": 2, "parametry": "12 powtórzeń na stronę", "miesnie": "Półkule mózgowe, elastyczność tułowia"},
        {"nazwa": "Neuromobilizacja nerwu udowego w leżeniu bokiem", "opis": "INSTRUKCJA: Leżenie na niećwiczonym boku. Mocno zegnij kolano (pięta do pośladka) z jednoczesnym odchyleniem głowy w tył. Następnie prostuj kolano z przyciągnięciem brody do mostka.", "czas_min": 2, "parametry": "15 płynnych ruchów", "miesnie": "Nerw udowy"},
        {"nazwa": "Sterowanie ruchem za pomocą wzroku (Oko-Ręka)", "opis": "INSTRUKCJA: Pacjent trzyma w dłoni wskaźnik laserowy. Celem jest płynne i precyzyjne wodzenie kropką lasera po wydrukowanym na ścianie labiryncie lub ósemce.", "czas_min": 3, "parametry": "3 minuty", "miesnie": "Integracja sensoryczna"},
        {"nazwa": "Neuromobilizacja nerwu promieniowego (ULNT 2b)", "opis": "INSTRUKCJA: Ramię lekko odwiedzione, łokieć wyprostowany, przedramię w pronacji (rotacji wewnętrznej). Wykonuj zgięcie dłoniowe nadgarstka przy jednoczesnym pochyleniu głowy w stronę ćwiczonej ręki, a następnie prostuj nadgarstek odchylając głowę.", "czas_min": 2, "parametry": "15 płynnych ruchów", "miesnie": "Nerw promieniowy"},
        {"nazwa": "Neuromobilizacja nerwu łokciowego (Maska Batmana)", "opis": "INSTRUKCJA: Zegnij łokieć, odwróć dłoń i przyłóż palce (wskazujący i kciuk ułożone w kółko) do oka, jakbyś zakładał maskę. Łokieć wędruje na zewnątrz. Ruch głową do boku naprzemiennie zwiększa i zmniejsza napięcie nerwu.", "czas_min": 2, "parametry": "15 płynnych ruchów", "miesnie": "Nerw łokciowy"},
        {"nazwa": "PNF - D2 Zgięcie kończyny górnej (Dobywanie miecza)", "opis": "INSTRUKCJA: Ruch zaczynamy od dłoni ułożonej na przeciwległym biodrze. Płynnym ruchem otwieramy dłoń i wznosimy ramię po skosie w górę i na zewnątrz, kończąc z dłonią otwartą w rotacji zewnętrznej nad głową.", "czas_min": 3, "parametry": "10 powtórzeń na stronę", "miesnie": "Łańcuchy kinematyczne obręczy barkowej"},
        {"nazwa": "PNF - Rytmiczna stabilizacja tułowia", "opis": "INSTRUKCJA: W siadzie lub klęku. Terapeuta przykłada opór z przodu i z tyłu tułowia naprzemiennie (np. pcha w prawe ramię z przodu i lewe z tyłu). Pacjent ma za zadanie utrzymać idealnie statyczną pozycję (izometria bez zmiany długości mięśnia).", "czas_min": 3, "parametry": "3x 15 sekund", "miesnie": "Core, autogenne hamowanie"},
        {"nazwa": "PIR (Poizometryczna Relaksacja) - Mięsień gruszkowaty", "opis": "INSTRUKCJA: Leżenie tyłem, noga zgięta ułożona w rotacji zewnętrznej (stopa za kolano drugiej nogi). Terapeuta spycha kolano w dół. Pacjent stawia lekki opór (ok. 20% siły) przez 8 sekund z wdechem, następnie wydech, relaks i terapeuta pogłębia zakres.", "czas_min": 4, "parametry": "3-5 cykli PIR", "miesnie": "M. gruszkowaty, odbarczenie n. kulszowego"},
        {"nazwa": "PIR (Poizometryczna Relaksacja) - Mięśnie podpotyliczne", "opis": "INSTRUKCJA: Leżenie tyłem, głowa w dłoniach terapeuty. Pacjent wykonuje delikatny nacisk potylicą w dół z jednoczesnym spojrzeniem gałek ocznych w górę (wdech, 8 sek). Wydech, spojrzenie w dół, relaks i terapeuta delikatnie pogłębia zgięcie górnej szyi.", "czas_min": 3, "parametry": "4 cykle PIR", "miesnie": "Mięśnie podpotyliczne, n. potyliczny większy"},
        {"nazwa": "Odruch przedsionkowo-oczny (VOR x1) - Fiksacja", "opis": "INSTRUKCJA: Siad. Wyciągnij przed siebie kciuk. Utrzymuj wzrok stale zogniskowany na kciuku, jednocześnie wykonując szybkie ruchy głową w prawo i w lewo. Obraz nie może się rozmazać.", "czas_min": 2, "parametry": "1 min horyzontalnie, 1 min wertykalnie", "miesnie": "Układ przedsionkowy, kontrola motoryczna wzroku"},
        {"nazwa": "PNF - Kombinacja skurczów izotonicznych", "opis": "INSTRUKCJA: Terapeuta aplikuje opór. Pacjent wykonuje ruch koncentryczny (np. pchanie), po dotarciu do końca zakresu przechodzi od razu w utrzymanie izometryczne, a następnie pozwala terapeucie na powolne zepchnięcie (praca ekscentryczna) bez rozluźnienia mięśnia.", "czas_min": 4, "parametry": "5 powtórzeń na wzorzec", "miesnie": "Torowanie nerwowo-mięśniowe (różne tryby pracy)"},
        {"nazwa": "Test Romberga - Trening propriocepcji w staniu", "opis": "INSTRUKCJA: Stopy złączone, ręce skrzyżowane na klatce piersiowej. Utrzymuj równowagę. Utrudnienie: zamknij oczy. Jeszcze wyższy stopień: odchyl głowę mocno w tył z zamkniętymi oczami.", "czas_min": 2, "parametry": "3x 30 sekund", "miesnie": "Czucie głębokie (propriocepcja)"},
        {"nazwa": "Y-Balance Test (Zegar) - Dynamiczna stabilność", "opis": "INSTRUKCJA: Stanie jednonóż na środku wyimaginowanego zegara lub litery Y. Drugą stopą sięgaj płynnie jak najdalej do przodu, potem po skosie w tył-prawo, potem po skosie w tył-lewo, nie tracąc równowagi na nodze podporowej.", "czas_min": 3, "parametry": "5 pełnych obwodów na nogę", "miesnie": "Stabilizacja miednicy, propriocepcja kończyny dolnej"},
        {"nazwa": "PNF - Wzorzec łopatki (Elewacja przednia)", "opis": "INSTRUKCJA: Leżenie na boku. Pacjent wypycha bark w kierunku ucha i nosa (po przekątnej) pokonując opór ręki terapeuty. Wzmacnia mięsień zębaty przedni i dźwigacz łopatki.", "czas_min": 2, "parametry": "3x10 powtórzeń", "miesnie": "Zębaty przedni, dźwigacz łopatki"},
        {"nazwa": "Chód tandemowy z zamkniętymi oczami", "opis": "INSTRUKCJA: Krok w krok (pięta do palców) wzdłuż prostej linii. Zadanie wykonywane z całkowicie zamkniętymi oczami. Wymaga asysty terapeuty w celu asekuracji.", "czas_min": 2, "parametry": "3x 5 metrów", "miesnie": "Integracja układu przedsionkowego (brak bodźców wzrokowych)"},
        {"nazwa": "Odbijanie piłki z podwójnym zadaniem (Dual-Task)", "opis": "INSTRUKCJA: Pacjent stoi na dysku sensorycznym. Terapeuta rzuca do niego piłkę tenisową w różnych płaszczyznach. Dodatkowo pacjent wymienia słowa na zadaną literę przy każdym złapaniu piłki.", "czas_min": 3, "parametry": "3 minuty ciągłej pracy", "miesnie": "Neurokognitywistyka, uwaga podzielna"},
        {"nazwa": "PIR (Poizometryczna Relaksacja) - Mięsień biodrowo-lędźwiowy", "opis": "INSTRUKCJA: Leżenie tyłem na skraju leżanki (test Thomasa). Noga ćwiczona zwisa swobodnie. Terapeuta stabilizuje miednicę i stawia opór na udzie zwisającej nogi, która lekko pcha w górę (wdech, 8 sek). Następnie wydech i swobodne opuszczenie nogi pod wpływem grawitacji.", "czas_min": 4, "parametry": "3-5 cykli PIR na nogę", "miesnie": "Biodrowo-lędźwiowy, torowanie wyprostu biodra"},
        {"nazwa": "Ćwiczenia Frenkla - Suwanie stopy po śladzie", "opis": "INSTRUKCJA: Siad. Na podłodze narysowany jest skomplikowany wzór (np. wężyk lub cyfra 8). Zadaniem pacjenta jest idealnie płynne, pozbawione drżeń przesuwanie dużego palca stopy wzdłuż tej linii w przód i w tył.", "czas_min": 3, "parametry": "3 minuty na nogę", "miesnie": "Układ pozapiramidowy, płynność ruchu"}
    ]
}
